...
const Posts = () => {
  const postImages = [
    ...
    'https://images.pexels.com/photos/15435913/pexels-photo-15435913/free-photo-of-person-wearing-white-sneakers.jpeg?auto=compress&cs=tinysrgb&w=600',
    'https://images.pexels.com/photos/1983036/pexels-photo-1983036.jpeg?auto=compress&cs=tinysrgb&w=600',
    'https://images.pexels.com/photos/5730519/pexels-photo-5730519.jpeg?auto=compress&cs=tinysrgb&w=600',
      ...
      <div className="posts">
        {posts.slice(0, visiblePosts).map((post, index) => (
          ...
          >
            ...
            />
            <p className="post-caption" style={{ color: 'black' }}>
              {post.caption}
            </p>
          </div>
        ))}
